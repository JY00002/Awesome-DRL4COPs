...
| 10 | A deep multi-agent reinforcement learning approach to solve dynamic job shop scheduling problem | Deep-MARL | DJSP | 2023 | [💻](https://github.com/RK0731/Deep-MARL-for-Dynamic-JSP) |
...
| 12 | Graph-based Reinforcement Learning for Flexible Job Shop Scheduling with Transportation Constraints | HJS | FJSP | 2023 | [💻](https://github.com/msh0576/FJSPT-Scheduler) |
...
| 15 | Introducing PetriRL: An innovative framework for JSSP resolution integrating Petri nets and event-based reinforcement learning | PetriRL | CJSP | 2024 | [💻](https://github.com/Sofiene-Uni/Intralogistics) |
...
| 19 | Residual Scheduling: A New Reinforcement Learning Approach to Solving Job Shop Scheduling Problem | RS | FJSP | 2024 | [💻](https://github.com/Raydiation/ResidualScheduling_IEEE_access) |
...
| 30 | Robust-stable scheduling in dynamic flow shops based on deep reinforcement learning | SXM3Q | MDFSP | 2024 | [💻](https://doi.org/10.17605/OSF.IO/SXM3Q) |
| 31 | Diverse policy generation for the flexible job-shop scheduling problem via deep reinforcement learning with a novel graph representation | EDSP | FJSP | 2025 | [💻](https://github.com/Echever/RL-for-FJSSP) |
| 32 | A modified multi-agent proximal policy optimization algorithm for multi-objective dynamic partial-re-entrant hybrid flow shop scheduling problem | MMAPPO | MDFFSP | 2025 | [💻](https://github.com/GarveyPython/MDPR-HFSP) |
...
> 
  ![Sankey diagram of multi-level taxonomy for scheduling problem](./Sankey_diagram/FIG25.png)
### 📚 Complete Paper List
